...
class CurlHttpClient(HttpClient):
    ...
    def build_request_cmd(self, url, headers, data=None, method=None):
        ...
        Args:
            ...
            method      : string    , specifies the http method to use (defaults to GET).
            insecure    : boolean   , enables/disables strict server certificate verification (defaults to False).
