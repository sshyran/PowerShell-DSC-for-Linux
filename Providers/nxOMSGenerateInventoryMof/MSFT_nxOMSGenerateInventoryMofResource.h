...
typedef struct _MSFT_nxOMSGenerateInventoryMofResource /* extends OMI_BaseResource */
{
    ...
    /*KEY*/ MI_ConstStringField FileName;
...
MI_INLINE MI_Result MI_CALL MSFT_nxOMSGenerateInventoryMofResource_Set_FileName(
...
MI_INLINE MI_Result MI_CALL MSFT_nxOMSGenerateInventoryMofResource_SetPtr_FileName(
    _Inout_ MSFT_nxOMSGenerateInventoryMofResource* self,
    _In_z_ const MI_Char* str)
{
    return self->__instance.ft->SetElementAt(
...
MI_INLINE MI_Result MI_CALL MSFT_nxOMSGenerateInventoryMofResource_Clear_FileName(
    _Inout_ MSFT_nxOMSGenerateInventoryMofResource* self)
{
